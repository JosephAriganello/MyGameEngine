...
public:
	...
	void CreateProgram(const std::string& shaderName_, const std::string& vertextShaderName_, const std::string&fragmentShaderName_);
...
private:
	...
	GLuint CreateShader(GLenum shaderType_, const std::string& source, const std::string& shaderName_);
