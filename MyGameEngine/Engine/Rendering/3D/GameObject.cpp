...
GameObject::GameObject(Model* model_) : position(glm::vec3(0.0f, 0.0f, 0.0f)), angle(0.0f), rotation(glm::vec3(0.0f, 1.0f, 0.0f)),
	scale(glm::vec3(1.0f)), tag(""), hit(false){
...
GameObject::GameObject(Model * model_, glm::vec3 position_) : position(glm::vec3(0.0f, 0.0f, 0.0f)), angle(0.0f), rotation(glm::vec3(0.0f, 1.0f, 0.0f)),
	scale(glm::vec3(1.0f)), tag(""), hit(false) {
	model = model_;
	position = position_;
	if (model) {
